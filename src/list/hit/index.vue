        ...
        <div class="main-block">
          <div class="avatar" sort-flag>
            <div class="default-img-bg">
              <img
                src="@/assets/648bbced128324a4b4ccf7db6c564a251744344.jpg"
          ...
          <div class="mb-outline-b content-wrapper">
            <div class="column content">
              <div class="box-flex movie-title">
                <div class="title line-ellipsis v3dimax_title">速度与激情：特别行动</div>
              ...
              <div class="detail column">
                ...
                <div class="actor line-ellipsis">主演: 道恩·强森,杰森·斯坦森,伊德瑞斯·艾尔巴</div>
...
export default {
  ...
  props:[],
  created(){
  //   this.axios.get(`http://api.douban.com/v2/movie/subject/1275443?apikey=0df993c66c0c636e29ecbb5344252a4a`).then(res=>{
  // console.log(result);
// })
    // this.aa();
  }
...
/* 字体的大小和 颜色，避免覆盖 */
.list-wrap .item .score,.actor,.show-info{
    font-size: 13px;
    color: #666;
}
/* 评分的单独颜色，大小 */
